    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(zhangjieCollection !=null){
            ...
            BeanUtils.copyProperties( zhangjieCollection , view );//把实体数据重构到view中
                ...
                //级联表
                XueshengEntity xuesheng = xueshengService.selectById(zhangjieCollection.getXueshengId());
                if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody ZhangjieCollectionEntity zhangjieCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            zhangjieCollection.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ZhangjieCollectionEntity> queryWrapper = new EntityWrapper<ZhangjieCollectionEntity>()
            ...
            .eq("xuesheng_id", zhangjieCollection.getXueshengId())
...
//                            zhangjieCollectionEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
