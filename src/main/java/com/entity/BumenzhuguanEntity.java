...
public class BumenzhuguanEntity<T> implements Serializable {
     ...
     * 部门主管姓名
     */
    @TableField(value = "bumenzhuguan_name")
     ...
     * 部门主管手机号
     */
    @TableField(value = "bumenzhuguan_phone")
     ...
     * 部门主管头像
     */
    @TableField(value = "bumenzhuguan_photo")
     ...
     * 电子邮箱
     */
    @TableField(value = "bumenzhuguan_email")
    ...
    public String toString() {
        return "Bumenzhuguan{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", bumenzhuguanName=" + bumenzhuguanName +
            ", bumenzhuguanPhone=" + bumenzhuguanPhone +
            ", bumenzhuguanPhoto=" + bumenzhuguanPhoto +
            ", sexTypes=" + sexTypes +
            ", bumenzhuguanEmail=" + bumenzhuguanEmail +
