<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='bumenzhuguan'"  label='部门主管姓名' prop="bumenzhuguanName">
               <el-input v-model="ruleForm.bumenzhuguanName"  placeholder='部门主管姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='bumenzhuguan'"  label='部门主管手机号' prop="bumenzhuguanPhone">
               <el-input v-model="ruleForm.bumenzhuguanPhone"  placeholder='部门主管手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='bumenzhuguan'" label='部门主管头像' prop="bumenzhuguanPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='bumenzhuguan'"  label='电子邮箱' prop="bumenzhuguanEmail">
               <el-input v-model="ruleForm.bumenzhuguanEmail"  placeholder='电子邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='xuesheng'"  label='余额' prop="newMoney">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.bumenzhuguanName)&& 'bumenzhuguan'==this.flag){
                             this.$message.error('部门主管姓名不能为空');
                             return
                         }

                             if( 'bumenzhuguan' ==this.flag && this.ruleForm.bumenzhuguanPhone&&(!isMobile(this.ruleForm.bumenzhuguanPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.bumenzhuguanPhoto)&& 'bumenzhuguan'==this.flag){
                             this.$message.error('部门主管头像不能为空');
                             return
                         }

                             if( 'bumenzhuguan' ==this.flag && this.ruleForm.bumenzhuguanEmail&&(!isEmail(this.ruleForm.bumenzhuguanEmail))){
