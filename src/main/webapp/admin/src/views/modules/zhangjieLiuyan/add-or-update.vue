    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="zhangjieLiuyanText">
                        <el-input type="textarea"  :readonly="ro.zhangjieLiuyanText" v-model="ruleForm.zhangjieLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhangjieLiuyanText" label="留言内容" prop="zhangjieLiuyanText">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //当前text不能修改
            this.ro.zhangjieLiuyanText = true;
            if (this.role != "管理员"){
            }
